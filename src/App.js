...
//       setUploadStatus('Image cropped and replaced!');
//       closeCropper();
//     } else {
...
//         <h2 style={{ margin: 0 }}>TinyMCE Editor with Image Crop, Video Upload, and Auto-Suggestions</h2>
//       </div>

//       {uploadStatus && (
//         <p
//           style={{
//             color: uploadStatus.toLowerCase().includes('fail') || uploadStatus.toLowerCase().includes('error') ? 'red' : 'green',
//             padding: '0 10px',
//           }}
//         >
//           {uploadStatus}
...
//           `,
//           setup: (editor) => {
//             // Autocompleter for suggestions triggered by '@'
//             editor.ui.registry.addAutocompleter('custom_suggestions', {
//               trigger: '@',
//               minChars: 1,
//               columns: 1,
//               fetch: (pattern) => {
...
//                     item.text.toLowerCase().startsWith(pattern.toLowerCase())
//                   );
//                   resolve(results);
//                 });
//               },
...
//             // Override the default pagebreak plugin behavior
//             editor.ui.registry.addButton('pagebreak', {
//               text: 'Page Break',
//               tooltip: 'Insert a page break',
//               onAction: () => {
//                 editor.insertContent('<div class="custom-pagebreak"></div>');
//               },
//             });
...
// //                     const file = input.files[0];
// //                     if (file) {
// //                       openCropper(file, (croppedDataUrl) => {
// //                         selectedNode.src = croppedDataUrl;
// //                         setUploadStatus('Image replaced with cropped version!');
// //                       });
// //                     } else {
// //                       setUploadStatus('No image selected.');
// //                     }
...
// //               text: 'Convert to PDF',
// //               tooltip: 'Convert editor content to PDF',
// //               onAction: () => {
// //                 convertToPDF();
// //               },
// //             });
...
// //               <button onClick={handleCrop}>Crop & Replace</button>
// //               <button onClick={closeCropper} style={{ marginLeft: '10px' }}>Cancel</button>
// //             </div>
// //           </div>
// //         </div>
// //       )}
...
//       {/* Rendered content for PDF/print */}
